      ...
      <section className="parallax-section">
        ...
        >
          ...
          <p className="vision-description">
            Buying a home isn't just a transaction — it's a turning point in
            your life. <br /> At Subh Housing, we honour that. Every
            conversation, every design,
            <br /> and every brick laid reflects our commitment to building not
            just houses,
            <br /> but homes where memories are made and futures are secured.
            <br /> You've worked hard for this moment —<br /> and we're here to
            make it worthwhile.
          </p>
        </div>
      </section>
